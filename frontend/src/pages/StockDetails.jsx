    ...
    <div className="min-h-screen bg-black text-white p-6 md:p-10">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-12 gap-8">
          <div className="animate-in fade-in slide-in-from-left duration-700 flex-1">
            <div className="flex flex-wrap items-end gap-5 mb-5">
              <h1 className="text-6xl md:text-7xl font-black tracking-tighter text-transparent bg-clip-text bg-linear-to-r from-gray-100 to-gray-400">
          ...
          <div className="w-full lg:w-[420px] bg-gray-950/40 backdrop-blur-xl border border-gray-800/60 rounded-3xl p-7 shadow-[0_0_40px_rgba(0,0,0,0.5)] animate-in fade-in slide-in-from-right duration-700 shrink-0">
            <div className="flex items-center justify-between gap-6 mb-8">
              ...
              <div className="text-right flex flex-col justify-center">
                ...
                <p className="text-2xl font-black text-transparent bg-clip-text bg-linear-to-r from-gray-100 to-gray-300">
            ...
            <div className="flex gap-4 mb-4">
              <button
                ...
                className="flex-1 bg-linear-to-b from-emerald-500 to-emerald-600 hover:from-emerald-400 hover:to-emerald-500 border border-emerald-500/20 text-white py-4 rounded-2xl font-black text-sm uppercase tracking-widest transition-all active:scale-95 shadow-[0_0_20px_rgba(16,185,129,0.2)] disabled:opacity-50"
              >
        ...
        <div className="flex gap-4 mb-12">
          <Link to={`/stocks/${symbol}/analysis`} className="flex-1 group relative overflow-hidden bg-gray-950/50 backdrop-blur-xl border border-purple-500/30 hover:border-purple-500/60 rounded-4xl p-1 transition-all duration-500 shadow-[0_0_40px_rgba(168,85,247,0.15)] hover:shadow-[0_0_60px_rgba(168,85,247,0.3)]">
            <div className="absolute inset-0 bg-linear-to-r from-purple-600/10 via-blue-600/10 to-purple-600/10 opacity-50 group-hover:opacity-100 transition-opacity duration-1000 bg-size-[200%_100%] animate-gradient-x" />
            ...
            <div className="flex bg-black/60 border border-white/5 rounded-xl p-1.5 shadow-inner">
              {['1D', '1W', '1M', '1Y'].map((range) => (
                <button
                  ...
                  className={`px-6 py-2 rounded-lg text-[10px] font-black uppercase tracking-[0.15em] transition-all duration-300 ${timeRange === range
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          <div className="lg:col-span-2 bg-gray-950/40 border border-white/5 rounded-3xl p-8 md:p-10 backdrop-blur-xl shadow-2xl">
            <h2 className="text-xl font-black mb-8 flex items-center text-transparent bg-clip-text bg-linear-to-r from-gray-100 to-gray-400">
...
function ProfileItem({ icon, label, value, isLink }) {
  return (
    <div className="flex items-start gap-4 p-4 rounded-2xl bg-white/2 border border-white/5 hover:bg-white/4 transition-colors">
